...
const WEBSERVER_IP = "http://192.168.1.6:8080";

export const STORE_API_ADRESS = "http://31.47.58.35:5004/tarazo"; //snapp api

export const RPI_PRINT_API = `${WEBSERVER_IP}/print`;
